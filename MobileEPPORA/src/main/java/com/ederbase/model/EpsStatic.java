...
public class EpsStatic {
	...
	public static final SimpleDateFormat dateFormatter = new SimpleDateFormat("ddMMMyy");
	public static final SimpleDateFormat timeFormatter = new SimpleDateFormat("HH:mm:ss");
	public static final SimpleDateFormat dateTimeFormatter = new SimpleDateFormat("ddMMMyy HH:mm:ss");
